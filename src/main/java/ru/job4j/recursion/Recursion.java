...
public class Recursion {
    ...
    public static void main(String[] args) {
        ...
        int result = recursion.loop(10, 5);
        System.out.println("result with loop = " + result);

        int result1 = recursion.sum(10, 5);
        System.out.println("result with recursion = " + result1);
    }
}
